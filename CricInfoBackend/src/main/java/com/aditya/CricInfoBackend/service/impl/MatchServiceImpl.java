package com.aditya.CricInfoBackend.service.impl;

import com.aditya.CricInfoBackend.model.Match;
import com.aditya.CricInfoBackend.repository.MatchRepo;
...
//                update the match in database
    ...
    private void updateMatch(Match match) {
        Match match1 = matchRepo.findByTeamHeading(match.getTeamHeading()).orElse(null);
        if(match1 == null)
        {
